...
export const translations: Record<"ar" | "en", TranslationDict> = {
  ar: {
    ...
    services: {
      ...
      valueAddedSmallCaption: "هذه الخدمات الإضافية مشمولة بالكامل ضمن الباقة القياسية دون أي رسوم أو تكاليف إضافية.",
    },
    about: {
  ...
  en: {
    ...
    services: {
      ...
      valueAddedSmallCaption: "These value-added logistical solutions are fully included in the standard contract framework at no extra price.",
    },
    about: {
