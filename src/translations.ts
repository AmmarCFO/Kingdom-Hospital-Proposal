...
export const translations: Record<"ar" | "en", TranslationDict> = {
  ar: {
    ...
    hero: {
      ...
      metaCommitment: "الحد الأدنى ١٢ شهرًا",
    ...
    stats: {
      ...
      optionsTitle: "٢",
      optionsSub: "خياران للتعاقد بمرونة عالية",
    ...
    pricing: {
      sectionTitle: "خيارات التسعير وباقات التعاقد",
      sectionSub: "نقدّم خيارين مرنين بهيكل تسعيري شفاف يركّز على الكفاءة وخفض التكاليف التشغيلية للمستشفى",
      bestValueBadge: "الأفضل قيمة والأقل تكلفة",
      ...
      opt1Title: "الباقة الأساسية (الموصى بها)",
      opt1Differentiator: "التزام ٢٤ شهرًا (أعلى توفير مالي)",
      opt2Title: "الباقة المرنة",
      opt2Differentiator: "التزام ١٢ شهرًا (مرونة قصوى)",
      comparisonTitle: "مقارنة جانبية شاملة بين الباقتين",
      comparisonSub: "جدول مالي تفصيلي لمقارنة التكاليف الكلية والسنوية لعدد ١٥٨ وحدة سكنية مغطاة",
      tableHeaders: {
        feature: "محددات الخدمة والمقارنة المالية",
        opt1: "الباقة الأساسية (٢٤ شهرًا)",
        opt2: "الباقة المرنة (١٢ شهرًا)",
      },
      tableRows: {
        commitment: "مدة الالتزام والتعاقد",
        commitmentValue1: "٢٤ شهرًا متواصلة",
        commitmentValue2: "١٢ شهرًا متواصلة",
        ...
        totalAnnualValue2: "٥٬٩٢٥٬٠٠٠ ريال سعودي",
        essentialServices: "باقة الخدمات الأساسية والتشغيل",
        valueAddedServices: "الخدمات الإضافية المشمولة مجانًا",
        vat: "ضريبة القيمة المضافة (VAT)",
        vatExcluded: "غير مشمولة (تُضاف قانونيًا)",
      },
      calculatorTitle: "مستكشف التكلفة التقديرية التفاعلي",
      calculatorSub: "قم بتعديل عدد الغرف لمعاينة الطاقة الاستيعابية والتكاليف المتوقعة مباشرةً حسب الباقة المختارة",
      ...
      calcSavings: "مقدار الوفر المالي السنوي عند اختيار الباقة الأساسية:",
      calcSelectPackage: "اختر الباقة الحالية لعرض التكلفة:",
    },
    services: {
      ...
      valueAddedTitle: "الخدمات الإضافية المشمولة مجانًا",
      valueAddedSub: "حلول إدارية وتنظيمية مبتكرة نلتزم بتقديمها دون أي رسوم ثانوية لتحسين جودة الحياة للتمريض",
      valueAddedItems: [
      ...
      valueAddedSmallCaption: "هذه الخدمات الإضافية مشمولة بالكامل ضمن كلا الخيارين (الباقة الأساسية والمرنة) دون أي رسوم أو تكاليف إضافية.",
    },
    about: {
    ...
    faq: {
      ...
      questions: [
        ...
        {
          q: "ما الفرق الرئيسي بين باقتي التعاقد؟",
          a: "يكمن الفرق بشكل جوهري في مدة الالتزام؛ الباقة الأساسية تشترط التزاماً لمدة ٢٤ شهراً وتوفر التكلفة الأقل والوفر الأعلى (١٬٣٢١ ريال/ممرضة شهرياً)، بينما الباقة المرنة تشترط التزاماً لمدة ١٢ شهراً فقط وبتكلفة تبلغ (١٬٥٦٢.٥٠ ريال/ممرضة شهرياً)."
        },
        {
    ...
    nextSteps: {
      ...
      step2Title: "٢. اختيار الباقة وتأكيد عدد الغرف",
      step2Desc: "تحديد الباقة الملائمة (الأساسية أو المرنة) مع تأكيد العدد النهائي المطلوب وتاريخ تدشين السكن الفعلي للتمريض.",
  ...
  en: {
    ...
    hero: {
      ...
      metaDocId: "MATHWAA-KINGDOM-2026",
      metaCommitment: "12-month minimum",
    ...
    stats: {
      ...
      optionsTitle: "2",
      optionsSub: "Flexible engagement contract options",
    ...
    pricing: {
      sectionTitle: "Pricing Options & Contracts",
      sectionSub: "We present two flexible contract frameworks with flat and transparent pricing layouts designed to maximize your healthcare operational efficiency.",
      bestValueBadge: "Best Value & Highest Savings",
      ...
      opt1Title: "Standard Package (Recommended)",
      opt1Differentiator: "24-month commitment (Max cost savings)",
      opt2Title: "Flexible Package",
      opt2Differentiator: "12-month commitment (Maximum adaptability)",
      comparisonTitle: "Side-by-Side Financial Comparison",
      ...
      tableRows: {
        ...
        totalAnnualValue2: "SAR 5,925,000",
        essentialServices: "Essential Utilities & Services Pack",
        valueAddedServices: "Value-Added Administrative Services",
        vat: "Value Added Tax (VAT)",
        vatExcluded: "Excluded extra (Added legally)",
      },
      calculatorTitle: "Interactive Monthly Cost Estimator",
      ...
      calcSavings: "Annual corporate savings realized with Standard Package:",
      calcSelectPackage: "Select a contract package structure:",
    },
    services: {
      ...
      valueAddedTitle: "Included Value-Added Services",
      valueAddedSub: "Exceptional administrative systems operated to boost quality of life and residential peace of mind at zero additional cost",
      valueAddedItems: [
      ...
      valueAddedSmallCaption: "These value-added logistical solutions are fully included in both contract paths at no extra price.",
    },
    about: {
    ...
    faq: {
      ...
      questions: [
        {
          q: "Can the number of units be adjusted after signing?",
          a: "Yes, modifications to the headcount are permitted subject to overall occupancy availability and formal consensus via a written contract addendum."
        },
        {
          q: "What is the key difference between the two packages?",
          a: "The difference lies entirely in commitment length. The Standard Package requires a 24-month commitment offering the lowest pricing (SAR 1,321/nurse/mo), while the Flexible Package guarantees a 12-month commitment but at a standard rate of SAR 1,562.50/nurse/mo."
        },
        {
    ...
    nextSteps: {
      ...
      step2Title: "2. Confirm Package & Headcount",
      step2Desc: "Select your desired package layout (Standard 24-mo or Flexible 12-mo) and finalize the precise launch dates.",
